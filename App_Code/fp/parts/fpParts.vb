...
Public Module fpParts
    ...
    Public Function partAdd(ByVal MEmfrID As Int32, ByVal mfrPartNum As String, ByVal TypeID As Int16, ByVal PkgTypeID As Int16, _
        ...
        Dim fD As New fpDistributor.fpDist(DistID)
        fD.AddPart(newPartID, DistPartNum)
    ...
    Public Class fpPart
        ...
        ReadOnly Property getManufacturer() As fpMfr
            Get
                Static iFpMfr As fpMfr = Nothing
                If iFpMfr Is Nothing Then
                    iFpMfr = New fpMfr(drPart.Field(Of Integer)("mfrID"))
                End If
                Return iFpMfr
            End Get
        End Property
        ...
        ReadOnly Property getPartNumber() As String
            Get
                Return drPart.Field(Of String)("mfrPartNum")
            End Get
        End Property

        ReadOnly Property getDescription() As String
            Get
                Return drPart.Field(Of String)("Description")
            End Get
        End Property

        ReadOnly Property getPartType() As String
            Get
                Return ptGetTypeName(drPart.Field(Of Integer)("TypeID"))
            End Get
        End Property

        ReadOnly Property getValue() As String
            Get
                Return drPart.Field(Of String)("Value") & " " & _
                    drPart.Field(Of String)("Value_Tolerance") & _
                    " " & drPart.Field(Of String)("Value_Units")
            End Get
        End Property
