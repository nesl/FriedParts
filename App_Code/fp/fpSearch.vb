...
Public Module fpSearch
    Private Const sqlCommonSelect As String = _
        "USE [FriedParts] " & _
        "SELECT " & _
        "    [part-PartTypes].[Type]" & _
        "   ,[mfr-Names].[mfrName]" & _
        "   ,[mfrPartNum]" & _
        "   ,[Description]" & _
        "   ,[Extra_Description]" & _
        "   ,[Value]" & _
        "   ,[Value_Units] AS [Units]" & _
        "   ,[Value_Tolerance] AS [Tol]" & _
        "   ,[Verified]" & _
        "   ,[Obsolete]" & _
        "   ,[RoHS]" & _
        "   ,[part-Common].[PartID]   " & _
        "FROM [part-Common] " & _
        "LEFT JOIN [part-PartTypes] " & _
        "   ON [part-PartTypes].[TypeID] = [part-Common].[TypeID] " & _
        "LEFT JOIN [mfr-Common] " & _
        "   ON [mfr-Common].[mfrID] = [part-Common].[mfrID] " & _
        "LEFT JOIN [mfr-Names] " & _
        "   ON [mfr-Names].[mfrNameID] = [mfr-Common].[mfrNameID] "
    ...
    Private Function fpSearchSqlGeneric(ByVal SearchCommand As String) As String
        ...
        sqlSearchQuery = sqlCommonSelect & _
            "   WHERE " & _
            "[mfr-Names].[mfrName] LIKE '%" & BLAH & "%' OR " & _
