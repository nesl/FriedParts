            ...
            <TabPages>
                ...
                <dxtc:TabPage Text="Search"><ContentCollection><dxw:ContentControl ID="ContentControl1" runat="server">                    
                    <asp:Panel ID="Panel5" runat="server" style="color:black;">
                        ...
                        <div style="float:left">
                            <dxrp:ASPxRoundPanel ID="xrpOctopart" runat="server" Width="400px" HeaderText="Octopart">
                                <PanelCollection>
                                    <dx:PanelContent ID="PanelContent15" runat="server">
                                        <table>
                                            <tr>
                                                <td>Powered By</td>
                                                <td><img src="../Images/Parts/octopart.gif" /></td>
                                            </tr>
                                        </table>
                                        <dxwgv:ASPxGridView ID="xGridOctopartMaster" KeyFieldName="MpnID" runat="server">
                                            <Columns>
                        ...
                        <div style="float:left; margin-left:10px;">
                            <dxrp:ASPxRoundPanel ID="xrpDigikey" runat="server" Width="400px" HeaderText="Digikey">
                                <PanelCollection>
                                    <dx:PanelContent ID="PanelContent16" runat="server">
                                        <dx:ASPxPanel ID="xPanelDkYes" runat="server" Width="200px" Visible="false">
                                            <PanelCollection><dx:PanelContent>
                                                <div style="float:left">
                                                    <asp:ImageButton ID="btnTransferToOctopart" runat="server" AlternateText="Click here to transfer data to Octopart" ImageUrl="~/Images/Parts/left_arrow.gif" />
                                                    <asp:HiddenField ID="hiddenDigikeyPartNumber" runat="server" />
                                                    <asp:HiddenField ID="hiddenMfrPartNumber" runat="server" />
                                                </div>
                                                <div style="float:left">
                                                    <dxe:ASPxLabel ID="xLblDigikey" runat="server" Text="">
                                                    </dxe:ASPxLabel>
                                                </div>
                                                <div style="float:right">
                                                    <asp:Image ID="imgDigikey" runat="server" />
                                                    <asp:HyperLink ID="linkDigikey" runat="server">Datasheet</asp:HyperLink>
                                                </div>
                                            </dx:PanelContent></PanelCollection>
                                        </dx:ASPxPanel>  
                                        <dx:ASPxPanel ID="xPanelDkNo" runat="server" Width="200px" Visible="false">
                                            <PanelCollection><dx:PanelContent>
                                                The keywords of your search do not match any Digikey part number. Please search again with a valid Digikey part number to unlock additional automation features (such as automatic part typing).</dx:PanelContent></PanelCollection>
                                        </dx:ASPxPanel>
                                    </dx:PanelContent>
                                </PanelCollection>
                            </dxrp:ASPxRoundPanel>
                ...
                <ContentCollection><dxw:ContentControl runat="server">
                    <asp:Panel ID="Panel4" runat="server" style="color:black;">
                        ...
                        <dxrp:ASPxRoundPanel ID="ImagePanel" runat="server" Width="700px" HeaderText="Image" ClientVisible="True">
                                <PanelCollection>
                                    ...
                                    <dx:ASPxDataView ID="ImageDataView" runat="server" collumnPerPage="3" AllowPaging="false">
                                            <ItemTemplate>
                                                <dxe:ASPxImage ID="ASPxImage2" runat="server" ImageUrl='<%# Eval("ImageURL") %>' Height="150px" Width="150px"></dxe:ASPxImage>
                                                <dxe:ASPxButton ID="ASPxImageButton" runat="server" Text="Select Image" OnCommand="ImageBtn_Click" CommandName='<%# Eval("ImageURL") %>'></dxe:ASPxButton>
                                            </ItemTemplate>
                                    </dx:ASPxDataView>
                                    </div>
                                    </dx:PanelContent>
                        ...
                        <br />                                               
                        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel7" runat="server" HeaderText="Part Description" Width="340px">
                            <PanelCollection>
