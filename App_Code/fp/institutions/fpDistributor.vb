...
Namespace fpDistributor
    Public Class fpDist
        Inherits fpInstitution.fpInst
        Public Const Prefix As String = "dist"
        Public Const TypeName As String = "distributor"

        Public Sub AddPart(ByVal PartNum As Int32, ByVal DistPartNum As String)
